...
const title = ['Booking code', 'Organizer name', 'Talent name', 'Thời gian biểu diễn', 'Giá'];
const data = {
...
const PDFExport = ({ bookings, fee }) => {
  ...
  <Document>
    <Page style={styles.body}>
      ...
      <Text style={styles.title}>Biên bản kế toán tháng 1/2023</Text>
      <Text style={styles.author}>Đặng Kim Bảo</Text>
      ...
      <ItemsTable data={bookings} title={title}/>
      <Text style={styles.text}>Fee: {fee.fee}</Text>
      <Text style={styles.text}>Price: {fee.price}</Text>
      <Text style={styles.text}>Tax: {fee.tax}</Text>
      <Text style={styles.text}>Total: {fee.total}</Text>
      <Text style={styles.text}>Unpaid: {fee.unpaidSum}</Text>
      ...
      <Image
        style={styles.image}
        src="https://blog.logrocket.com/wp-content/uploads/2021/12/generating-pdfs-react.png"
      />
      <Text style={styles.text}>
